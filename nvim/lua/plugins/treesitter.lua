        ...
        textobjects = {
          select = {
            ...
            keymaps = {
              ...
              -- entry
              ["ae"] = { query = "@entry.outer", desc = "Select outer part of an entry" },
              ["ie"] = { query = "@entry.inner", desc = "Select inner part of an entry" },
              -- ["le"] = { query = "@entry.lhs", desc = "Select left part of an entry" },
              ["re"] = { query = "@entry.rhs", desc = "Select right part of an entry" },
          ...
          move = {
            ...
            goto_next_start = {
              ...
              ["]e"] = { query = "@entry.outer", desc = "Next entry start" },
            ...
            goto_next_end = {
              ...
              ["]E"] = { query = "@entry.outer", desc = "Next entry end" },
            },
            goto_previous_start = {
              ...
              ["[e"] = { query = "@entry.outer", desc = "Prev entry start" },
            },
            goto_previous_end = {
              ...
              ["[E"] = { query = "@entry.outer", desc = "Prev entry end" },
            },
          },
        },
      })
